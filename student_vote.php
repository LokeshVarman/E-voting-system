...
$result = mysql_query($sql);
	   ...
	   // echo $cand1;
        $msg="<center><h4><font color='#FFFFFF'>You have already been voted, No need to vote again</h4></center></font>";
		include 'student.php';
		exit();	
	        }
	...
	$msg="<center><h4><font color='#FFFFFF'>Congratulation, you have made your vote.</h4></center></font>";
	include 'student.php';
	exit();
	}
			}
